$(function () {
    ...
    $("#ostDnf").mouseenter(function () {
        $(this).addClass("hide");
        //$("#ostPic").removeClass("hide");
        $("#ostPic").removeClass("hide");
        $("#ostTx").css("zIndex", 2);
        $("#gameTop").css("zIndex", 2);
        $("#ostLog").css("zIndex", 2);

    })
    //鼠标离开大广告时，让当前盒子隐藏，删除之前设置的层级样式，并显示DNF广告
    $("#ostPic").mouseleave(function () {
        $(this).addClass("hide");
        $("#ostDnf").removeClass("hide");
        $("#ostTx").removeAttr("style");
        $("#gameTop").removeAttr("style");
    });
    ...
    $("#gameTop").mouseenter(function () {
        ...
        $(this).children("div").show().removeClass("hide");
    });
    //鼠标离开排行榜时，隐藏ostRank
